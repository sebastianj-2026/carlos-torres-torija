...
// Logo SVG del sistema "OFICINA TS"
const Logo: React.FC = () => (
  <div className="flex flex-col items-center gap-3">
    {/* Ícono geométrico */}
    <div className="relative w-16 h-16">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg shadow-orange-500/30 rotate-6" />
      <div className="absolute inset-0 bg-slate-900 rounded-2xl flex items-center justify-center">
        <svg viewBox="0 0 48 48" className="w-8 h-8" fill="none">
          ...
          <circle cx="24" cy="24" r="8" fill="none" stroke="#F97316" strokeWidth="2.5" />
    ...
    <div className="text-center leading-none">
      <span className="text-2xl font-light tracking-[0.25em] text-slate-300 uppercase">
        OFICINA
      </span>
      <span className="text-2xl font-black tracking-widest text-orange-500 ml-2">
        TS
      </span>
    </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-zinc-900 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="text-center text-xs text-slate-600 mt-4">
          OFICINA TS &copy; {new Date().getFullYear()} — v1.0.0
        </p>
      </div>
    </div>
  );
